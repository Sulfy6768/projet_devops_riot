...
try:
    from .lolalytics_scraper import scraper, get_counter_score, get_blindpick_score, get_champion_stats, ROLE_MAP
...
def get_recommendations(
    ...
    for mastery in masteries[:30]:
        ...
        recommendations.append({
            ...
            'blindpick_score': round(blindpick_score_value * 100, 1) if mode == "blind" else None,
            'games_in_meta': games,
            'reason': ' • '.join(reasons),
            'mode': mode
        })
